   ...
   public class CardRes
    {
        ...
        public CardRes()
        {
            ...
            Heros = new List<Hero>();
            Heros.Add(new Hero(0, "", FunctionType.nothing, @"\Res\Cards\hero_Back.png", "角色"));
            ...
            Buildings.Add(new Building(0, 0, "", FunctionType.nothing, @"\Res\Cards\building_Back.png", "建筑"));
            int startNum = 1;
            ...
            Add(Buildings, FunctionType.religious, "大教堂", 5, @"\Res\Cards\religiousBuilding_Cathedral.png", "大教堂", ref startNum, 2);
            Add(Buildings, FunctionType.religious, "教堂", 2, @"\Res\Cards\religiousBuilding_Church.png", "教堂", ref startNum, 3);
            Add(Buildings, FunctionType.religious, "修道院", 3, @"\Res\Cards\religiousBuilding_Monastery.png", "修道院", ref startNum, 3);
            Add(Buildings, FunctionType.religious, "神殿", 1, @"\Res\Cards\religiousBuilding_Temple.png", "神殿", ref startNum, 3);
            Add(Buildings, FunctionType.commercial, "海港", 4, @"\Res\Cards\tradeBuilding_Harbour.png", "海港", ref startNum, 3);
            Add(Buildings, FunctionType.commercial, "市场", 2, @"\Res\Cards\tradeBuilding_Market.png", "市场", ref startNum, 4);
            Add(Buildings, FunctionType.commercial, "酒馆", 1, @"\Res\Cards\tradeBuilding_Pub.png", "酒馆", ref startNum, 5);
            Add(Buildings, FunctionType.commercial, "市政厅", 5, @"\Res\Cards\tradeBuilding_Townhouse.png", "市政厅", ref startNum, 2);
            Add(Buildings, FunctionType.commercial, "贸易站", 2, @"\Res\Cards\tradeBuilding_TradingPost.png", "贸易站", ref startNum, 3);
            Add(Buildings, FunctionType.commercial, "码头", 3, @"\Res\Cards\tradeBuilding_Wharf.png", "码头", ref startNum, 3);
